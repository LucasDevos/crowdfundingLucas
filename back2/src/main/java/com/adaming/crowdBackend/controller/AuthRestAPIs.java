...
import com.adaming.crowdBackend.message.request.LoginForm;
import com.adaming.crowdBackend.message.request.SignUpForm;
import com.adaming.crowdBackend.message.response.JwtResponse;
import com.adaming.crowdBackend.message.response.ResponseMessage;
...
import com.adaming.crowdBackend.security.jwt.JwtProvider;
...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
		...
		// ADDITION : create corresponding Contributor
		Contributor c = new Contributor();
		String avatar = "https://i.pravatar.cc/150?img="+((int) (Math.random()*70) + 1);
